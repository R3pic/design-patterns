import { Singleton } from "src/design-patterns/creational-patterns/singleton-pattern/broke-example/refection-example/solution/singleton.ts";
import {ExampleRunner} from '@example-runner';

export default class SingletonRefectionBrokenSolutionExampleRunner extends ExampleRunner {
  static name = '싱글턴 패턴 리플렉션 취약점 해결 예제';
